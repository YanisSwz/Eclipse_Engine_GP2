...
namespace ImGui
{
    ...
    IMGUI_API bool          ImageSlider(const char* label, ImTextureID user_texture_id, const ImVec2& image_size, const ImVec2& size, float* v, float v_min, float v_max, const char* format = "%.3f", ImGuiSliderFlags flags = 0);
