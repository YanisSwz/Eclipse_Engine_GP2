...
class ParticleCollider : public Core::MonoBehaviour
{
public:
	ParticleCollider();
	~ParticleCollider() override;
...
private:
	std::vector<Core::ParticleEmitter*> m_particleEmitters;
};

REGISTER_TYPE(ParticleCollider);