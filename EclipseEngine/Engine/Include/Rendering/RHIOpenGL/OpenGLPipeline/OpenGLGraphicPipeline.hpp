...
namespace RHI::OpenGL
{
	...
	public:
		...
		virtual void Draw(Math::Mat4 _VP, Math::Vec3 _viewPos, std::vector<Resource::ModelData> _staticModels, RHI::LightsData _lightsData, std::vector<std::vector<Core::ParticleRenderData>> _particleData) override = 0;
