...
namespace Math
{
	...
	public:
		...
		static Vec2 Zero();
		static Vec2 One();
		static Vec2 Opposite(Vec2 _vec);
		static Vec2 MidPoint(Vec2 _vec1, Vec2 _vec2);
		static float Distance(Vec2 _vec1, Vec2 _vec2);
		static float SquareNorm(Vec2 _vec);
		static float Norm(Vec2 _vec);
		static float DotProduct(Vec2 _vec1, Vec2 _vec2);
		static float CrossProduct(Vec2 _vec1, Vec2 _vec2);
		static Vec2 Rotate(Vec2 _vec, float _theta, Vec2 _anchor = { 0.f, 0.f });
		static void Print(Vec2 _vec);
